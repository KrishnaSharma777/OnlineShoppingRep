...
export default class HomePage extends Component {
  ...
  render() {
    ...
    const headerStyle = {
      ...
      backgroundImage: 'url("./components/Asset/blackfoot.jpg")', // Replace with the actual filename and extension
    ...
    return (
      <div className="HomePage-Container"  >
          ...
          <div className="HomePage-SubContainer-Header">
            ...
            >
              <Toolbar >
                ...
                >
                 <h1 style={{color:'green'}}> Welcome To Medical Footware </h1>&nbsp;
        ...
        <marquee behavior="scroll" direction="left">
          Todays offer:- 20% discount & You can     
